    ...
    <>
      <div className={`z-stars ${data.size} ${data.className}`}>
        ...
        <div className="text-value">
          ...
          {data.showOutOfText === true ? ` out of 5` : ""}
        </div>
      </div>
...
export function ZStarsCount(data: IZStars) {
  return (
    <div className="z-stars-count">
      <img src={startYellow.src} alt="Stars count" />
      <span>
        {data.value} ({data.reviewsCount})
      </span>
    </div>
  );
}
