                ...
                <div className="panel-content-wrap">
                  <div className="confirmation-stars-panel">
                    ...
                    <div className="the-content">
                      <h1>Thank you</h1>
                      <p>Your subscription has been updated to the <strong>{
                        prettifySlug(user.defaultListing.plan_subscribtion_details.plan_slug as string)}</strong> plan. A receipt has been sent to your email. Thank you for choosing us to help scale your business.</p>
                    </div>
