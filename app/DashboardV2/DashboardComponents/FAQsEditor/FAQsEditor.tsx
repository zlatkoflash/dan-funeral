  ...
  return <>
    <div className="services-editor text-input-wrap">
      ...
      <div className="heading">
        <label htmlFor="business-name" className="form-label">Frequently asked questions</label>

        <div className="right-buttons">
          <Button type="button" variant="light" className="btn-equal-icon" onClick={() => {
            console.log("It is working..., dashboardSlice.actions.setModalShow_FAQsReorder:", dashboardSlice.actions.setModalShow_FAQsReorder);
    ...
    <ModalFAQsReorder
      faqs={faqsBusiness}
      onUpdateOrder={(faq: IFAQBusiness, index: number, direction: 'up' | 'down') => {
